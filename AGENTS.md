...
- **Use caret requirements, including explicitly named prereleases.** For example, `"^2.0.0-alpha.1"` opts into the prerelease; `"^2.0"` does not. Do not introduce exact pins.
